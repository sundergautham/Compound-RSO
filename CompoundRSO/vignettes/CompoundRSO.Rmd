...
* Carry out model selection for the starting design DSD. The function DSD model selection returns the column names of active main effects, 2FI and QE in te standard notation.
```{r echo = T,eval=FALSE}
